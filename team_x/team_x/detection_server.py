...
DEFAULT_SAVE_DIR = Path.home() / 'cs477_ws' / 'team_x_detection_results'
...
class RgbdDetectionPoseServer(Node):
    def __init__(self):
        super().__init__('team_x_rgbd_detection_pose_server')
        ...
        self.declare_parameter('annotated_image_topic', '/team_x/detection/annotated_image')
        self.declare_parameter('roi_mask_topic', '/team_x/detection/roi_mask')
        self.declare_parameter('roi_info_topic', '/team_x/detection/info')
        self.declare_parameter('roi_points_topic', '/team_x/detection/roi_points')
