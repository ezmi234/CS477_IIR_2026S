...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'summarize_calibration_results = team_1.tools.summarize_calibration_results:main',
            'test_can_disambiguation = team_1.tools.test_can_disambiguation:main',
            'test_object_disambiguation = team_1.tools.test_can_disambiguation:main',
